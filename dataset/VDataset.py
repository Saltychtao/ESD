...
def collate(
    ...
    if samples[0].get('bag_of_sememe',None) is not None:
        bag_of_sememe = merge('bag_of_sememe',left_pad=left_pad_target)
        bag_of_sememe = bag_of_sememe.index_select(0,sort_order)
    else:
        bag_of_sememe = None
...
class VDGMDataset(FairseqDataset):
    """
    ...
    def __init__(
            self, words,src,src_sizes, src_dict,
            tgt=None, tgt_sizes=None, tgt_dict=None,
            left_pad_source=True, left_pad_target=False,
            max_source_positions=1024, max_target_positions=1024,
            shuffle=True, input_feeding=True, remove_eos_from_source=False, append_eos_to_target=False,
            ppmi_map=None,bert_repre=None,sememes=None
    ):
    ...
    def __getitem__(self, index):
        ...
        if self.sememes is not None:
            ...
            if self.sememes[index][-1] == eos:
                bag_of_sememe = self.sememes[index][:-1]
            else:

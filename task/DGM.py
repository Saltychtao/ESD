...
from VariationalDefinitionGeneration.dataset.dataset import DGMDataset
...
@fairseq.tasks.register_task('DGM')
class DGMTask(FairseqTask):
    """
    ...
    def build_dataset_for_inference(self,positions,words,src_tokens, src_lengths):
        return DGMDataset(positions,words,src_tokens, src_lengths, self.source_dictionary)
